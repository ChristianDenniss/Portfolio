...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Python', 'UI/UX Design', 'Google Sheets API', 'Data Analysis'],
