...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Google Earth Engine', 'Graduate level research', 'Satellite Data', 'Data Scraping', 'Predictive Modelling', 'Geospatial Analytics', 'Ontologies', 'Bi-directional Feedback Loop', 'Redis'],
      image: '/images/DT.png',
