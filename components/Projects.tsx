...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Java', 'JavaFX','Complex Arrays', 'Algorithms', 'Game Logic', 'Object-Oriented Programming'],
